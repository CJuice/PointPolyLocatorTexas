...
//	private static final String JET_SERVLET_URL_FOR_RESPONSE = "/TempDisplayOfGPOutcome.xhtml";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (sdo.checkForValidSpatialCoordinates(latitude, longitude)) {
			...
			//TESTING
			//Invalid
//			request.setAttribute("county", "Null");
//			request.setAttribute("lepc", "Null");
//			request.setAttribute("message", "Bad Coordinate Value");
//			sdo.setErrorMessage("Bad Coordinate Value");
//			request.setAttribute("sdo", sdo); 
//			getServletContext().getRequestDispatcher(JET_SERVLET_URL_FOR_RESPONSE).forward(request, response);
		...
		if (tempArrayListOfFileLines.isEmpty()) {
			...
			//TESTING
			// Set the attributes to make them available to JSF or servlet
//			request.setAttribute("county", "Null");
//			request.setAttribute("lepc", "Null");
//			request.setAttribute("message", "No File Existed Due to Bad Coordinates");
//			sdo.setErrorMessage("No File Existed Due to Bad Coordinates");
//			request.setAttribute("sdo", sdo);
//			getServletContext().getRequestDispatcher(JET_SERVLET_URL_FOR_RESPONSE).forward(request, response);
			...
			//TESTING
			// Set the attributes to make them available to JSF or servlet
//			request.setAttribute("county", sdo.getNameTXCounty());
//			request.setAttribute("lepc", sdo.getNameLEPC());
//			request.setAttribute("message", sdo.getErrorMessage());
//			request.setAttribute("filepath", sdo.getFilePath()); 
//			request.setAttribute("sdo", sdo);
//			getServletContext().getRequestDispatcher(JET_SERVLET_URL_FOR_RESPONSE).forward(request, response);
